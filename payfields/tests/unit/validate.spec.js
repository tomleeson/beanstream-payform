describe('Validator', function () {
  ...
  it('should reject expired dates', function () {
    ...
    expect(beanstream.Validator.isValidExpiryDate('01/16', new Date(2016, 1)).isValid).toBe(false);
  });

   it('should accept valid dates', function () {

    //'02/2016' = Feb, Date(2016, 1) = Feb
    expect(beanstream.Validator.isValidExpiryDate('02/16', new Date(2016, 1)).isValid).toBe(true);
    //'04/2016' = Apr, Date(2016, 2) = Mar
    expect(beanstream.Validator.isValidExpiryDate('04/16', new Date(2016, 2)).isValid).toBe(true);
  });
